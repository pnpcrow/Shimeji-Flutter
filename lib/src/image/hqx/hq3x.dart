// Generated from hqx-java (Hq3x.java) - hqx algorithm by
...
class Hq3x {
  ...
  /// Upscales ARGB pixel data by 3x using hq3x.
  static void scale3(List<int> sp, List<int> dp, int xRes, int yRes) {
    scale3Full(sp, dp, xRes, yRes, 48, 7, 6, 0, false, false);
  }

  static void scale3Full(
            ...
            for (int i = 0; i < xRes; i++) {
                ...
                switch (pattern) {
                    case 0 || 1 || 4 || 5 || 32 || 33 || 36 || 37 || 128 || 129 || 132 || 133 || 160 || 161 || 164 || 165: {
                        ...
                        dp[dpIdx + 2] = HqxUtil.mix2To1To1(w[4], w[1], w[5]);
                        dp[dpIdx + dpL] = HqxUtil.mix3To1(w[4], w[3]);
                        dp[dpIdx + dpL + 1] = w[4];
                        dp[dpIdx + dpL + 2] = HqxUtil.mix3To1(w[4], w[5]);
                        dp[dpIdx + dpL + dpL] = HqxUtil.mix2To1To1(w[4], w[7], w[3]);
                        dp[dpIdx + dpL + dpL + 1] = HqxUtil.mix3To1(w[4], w[7]);
                        dp[dpIdx + dpL + dpL + 2] = HqxUtil.mix2To1To1(w[4], w[5], w[7]);
                    }
                    case 2 || 34 || 130 || 162: {
                    ...
                    case 16 || 17 || 48 || 49: {
                        ...
                        dp[dpIdx + dpL + dpL] = HqxUtil.mix2To1To1(w[4], w[7], w[3]);
                        dp[dpIdx + dpL + dpL + 1] = HqxUtil.mix3To1(w[4], w[7]);
                        dp[dpIdx + dpL + dpL + 2] = HqxUtil.mix3To1(w[4], w[8]);
                    }
                    case 64 || 65 || 68 || 69: {
                        dp[dpIdx] = HqxUtil.mix2To1To1(w[4], w[3], w[1]);
                        dp[dpIdx + 1] = HqxUtil.mix3To1(w[4], w[1]);
                    ...
                    case 6 || 38 || 134 || 166: {
                        dp[dpIdx] = HqxUtil.mix3To1(w[4], w[0]);
                        dp[dpIdx + 1] = w[4];
                        dp[dpIdx + 2] = HqxUtil.mix3To1(w[4], w[5]);
                        dp[dpIdx + dpL] = HqxUtil.mix3To1(w[4], w[3]);
                        dp[dpIdx + dpL + 1] = w[4];
                        dp[dpIdx + dpL + 2] = HqxUtil.mix3To1(w[4], w[5]);
                        dp[dpIdx + dpL + dpL] = HqxUtil.mix2To1To1(w[4], w[7], w[3]);
                    ...
                    case 144 || 145 || 176 || 177: {
                        ...
                        dp[dpIdx + dpL + dpL] = HqxUtil.mix2To1To1(w[4], w[7], w[3]);
                        dp[dpIdx + dpL + dpL + 1] = HqxUtil.mix3To1(w[4], w[7]);
                        dp[dpIdx + dpL + dpL + 2] = HqxUtil.mix3To1(w[4], w[7]);
                    }
                    case 192 || 193 || 196 || 197: {
                        ...
                        dp[dpIdx + dpL + dpL] = HqxUtil.mix3To1(w[4], w[6]);
                        dp[dpIdx + dpL + dpL + 1] = w[4];
                        dp[dpIdx + dpL + dpL + 2] = HqxUtil.mix3To1(w[4], w[5]);
                    }
                    case 96 || 97 || 100 || 101: {
                        dp[dpIdx] = HqxUtil.mix2To1To1(w[4], w[3], w[1]);
                        dp[dpIdx + 1] = HqxUtil.mix3To1(w[4], w[1]);
                    ...
                    case 40 || 44 || 168 || 172: {
                        ...
                        dp[dpIdx + dpL + 1] = w[4];
                        dp[dpIdx + dpL + 2] = HqxUtil.mix3To1(w[4], w[5]);
                        dp[dpIdx + dpL + dpL] = HqxUtil.mix3To1(w[4], w[7]);
                        dp[dpIdx + dpL + dpL + 1] = HqxUtil.mix3To1(w[4], w[7]);
                        dp[dpIdx + dpL + dpL + 2] = HqxUtil.mix2To1To1(w[4], w[5], w[7]);
                    }
                    case 9 || 13 || 137 || 141: {
                    ...
                    case 18 || 50: {
                        ...
                        if (HqxUtil.diff(w[1], w[5], trY, trU, trV, trA)) {
                            ...
                            dp[dpIdx + 1] = HqxUtil.mix7To1(w[4], w[1]);
                            dp[dpIdx + 2] = HqxUtil.mix2To7To7(w[4], w[1], w[5]);
                    ...
                    case 80 || 81: {
                        ...
                        if (HqxUtil.diff(w[5], w[7], trY, trU, trV, trA)) {
                            ...
                            dp[dpIdx + dpL + dpL + 2] = HqxUtil.mix2To7To7(w[4], w[5], w[7]);
                        }
                    }
                    case 72 || 76: {
                        dp[dpIdx] = HqxUtil.mix3To1(w[4], w[0]);
                        ...
                        if (HqxUtil.diff(w[7], w[3], trY, trU, trV, trA)) {
                            ...
                            dp[dpIdx + dpL] = HqxUtil.mix7To1(w[4], w[3]);
                            dp[dpIdx + dpL + dpL] = HqxUtil.mix2To7To7(w[4], w[7], w[3]);
                            dp[dpIdx + dpL + dpL + 1] = HqxUtil.mix7To1(w[4], w[7]);
                        }
                        dp[dpIdx + dpL + dpL + 2] = HqxUtil.mix3To1(w[4], w[8]);
                    }
                    case 10 || 138: {
                        if (HqxUtil.diff(w[3], w[1], trY, trU, trV, trA)) {
                            ...
                            dp[dpIdx] = HqxUtil.mix2To7To7(w[4], w[3], w[1]);
                            dp[dpIdx + 1] = HqxUtil.mix7To1(w[4], w[1]);
                            dp[dpIdx + dpL] = HqxUtil.mix7To1(w[4], w[3]);
                        }
                        dp[dpIdx + 2] = HqxUtil.mix3To1(w[4], w[2]);
                    ...
                    case 19 || 51: {
                        if (HqxUtil.diff(w[1], w[5], trY, trU, trV, trA)) {
                            ...
                            dp[dpIdx + 2] = HqxUtil.mixEven(w[1], w[5]);
                            dp[dpIdx + dpL + 2] = HqxUtil.mix3To1(w[4], w[5]);
                        }
                        dp[dpIdx + dpL] = HqxUtil.mix3To1(w[4], w[3]);
                        dp[dpIdx + dpL + 1] = w[4];
                    ...
                    case 146 || 178: {
                        if (HqxUtil.diff(w[1], w[5], trY, trU, trV, trA)) {
                            ...
                            dp[dpIdx + 1] = HqxUtil.mix3To1(w[4], w[1]);
                            dp[dpIdx + 2] = HqxUtil.mixEven(w[1], w[5]);
                            dp[dpIdx + dpL + 2] = HqxUtil.mix3To1(w[5], w[4]);
                            dp[dpIdx + dpL + dpL + 2] = HqxUtil.mix2To1To1(w[4], w[5], w[7]);
                        }
                        dp[dpIdx] = HqxUtil.mix3To1(w[4], w[0]);
                        dp[dpIdx + dpL] = HqxUtil.mix3To1(w[4], w[3]);
                    ...
                    case 84 || 85: {
                        if (HqxUtil.diff(w[5], w[7], trY, trU, trV, trA)) {
                            ...
                            dp[dpIdx + dpL + 2] = HqxUtil.mix3To1(w[5], w[4]);
                            dp[dpIdx + dpL + dpL + 1] = HqxUtil.mix3To1(w[4], w[7]);
                            dp[dpIdx + dpL + dpL + 2] = HqxUtil.mixEven(w[5], w[7]);
                        }
                        dp[dpIdx] = HqxUtil.mix2To1To1(w[4], w[3], w[1]);
                        dp[dpIdx + 1] = HqxUtil.mix3To1(w[4], w[1]);
                        dp[dpIdx + dpL] = HqxUtil.mix3To1(w[4], w[3]);
                    ...
                    case 112 || 113: {
                        if (HqxUtil.diff(w[5], w[7], trY, trU, trV, trA)) {
                            ...
                            dp[dpIdx + dpL + 2] = HqxUtil.mix3To1(w[4], w[5]);
                            dp[dpIdx + dpL + dpL] = HqxUtil.mix2To1To1(w[4], w[7], w[3]);
                            dp[dpIdx + dpL + dpL + 1] = HqxUtil.mix3To1(w[7], w[4]);
                            dp[dpIdx + dpL + dpL + 2] = HqxUtil.mixEven(w[5], w[7]);
                        }
                        dp[dpIdx] = HqxUtil.mix2To1To1(w[4], w[3], w[1]);
                        dp[dpIdx + 1] = HqxUtil.mix3To1(w[4], w[1]);
                    ...
                    case 200 || 204: {
                        if (HqxUtil.diff(w[7], w[3], trY, trU, trV, trA)) {
                            ...
                            dp[dpIdx + dpL] = HqxUtil.mix3To1(w[4], w[3]);
                            dp[dpIdx + dpL + dpL] = HqxUtil.mixEven(w[7], w[3]);
                            dp[dpIdx + dpL + dpL + 1] = HqxUtil.mix3To1(w[7], w[4]);
                            dp[dpIdx + dpL + dpL + 2] = HqxUtil.mix2To1To1(w[4], w[5], w[7]);
                        }
                        dp[dpIdx] = HqxUtil.mix3To1(w[4], w[0]);
                    ...
                    case 42 || 170: {
                        if (HqxUtil.diff(w[3], w[1], trY, trU, trV, trA)) {
                            ...
                            dp[dpIdx] = HqxUtil.mixEven(w[3], w[1]);
                            dp[dpIdx + 1] = HqxUtil.mix3To1(w[4], w[1]);
                            dp[dpIdx + dpL] = HqxUtil.mix3To1(w[3], w[4]);
                            dp[dpIdx + dpL + dpL] = HqxUtil.mix2To1To1(w[4], w[7], w[3]);
                        }
